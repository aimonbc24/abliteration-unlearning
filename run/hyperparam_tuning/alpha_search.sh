...
do
    ...
    python abliterate_copy.py $results_file --dataset_name $dataset --layer $layer --num_perturbed $num_perturbed --alpha $alpha --intervention_name L$layer-P$num_perturbed-A$alpha --results_file $results_file
